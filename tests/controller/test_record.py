...
from cascade.low.core import Environment, Worker, TaskId, JobInstance, WorkerId
from cascade.low.views import param_source
from cascade.scheduler.graph import precompute

from ..scheduler.util import get_job1
...
def test_2l_2sink():
    ...
    def test(environment: Environment) -> tuple[float, dict[WorkerId, int]]:
