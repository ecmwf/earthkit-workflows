...
class TestDepthFirstScheduler:
    ...
    def setup_method(self, method):
        ...
        self.contexts.add_node("gpu_1", type="GPU", speed=10, memory=40)
        self.contexts.add_node("gpu_2", type="GPU", speed=10, memory=20)
        self.contexts.add_node("gpu_3", type="GPU", speed=5, memory=20)
        self.contexts.add_node("gpu_4", type="GPU", speed=5, memory=20)
